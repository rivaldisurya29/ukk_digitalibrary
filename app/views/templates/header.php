...
<head>
  ...
  <title>PERPUSTAKAAN RIVALDI | <?= getTitle(); ?></title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-purple navbar-light">
    ...
    <a href="#" class="d-block text-white">Halo <?= $_SESSION['username']; ?> anda sebagai <?= $_SESSION['role']; ?></a>
...
<h5>Perpustakaan Digital</h5>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item float-button">
